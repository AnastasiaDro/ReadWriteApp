        ...
        FairyTaleContent(
            ...
            storyLines = listOf(
                FairyTaleStoryLine(
                    ...
                    soundResourcePath = "files/horse_story/1_horse_love.m4a",
                    soundFileName = "1_horse_love.m4a",
                    playbackVisual = horseLoveVisual,
                ),
                FairyTaleStoryLine(
                    text = "Причешу ей шёрстку гладко",
                    soundResourcePath = "files/horse_story/2_horse_fure.m4a",
                    soundFileName = "2_horse_fure.m4a",
                    playbackVisual = horseFureVisual,
                ),
                FairyTaleStoryLine(
                    text = "Гребешком приглажу хвостик",
                    soundResourcePath = "files/horse_story/3_horse_tail.m4a",
                    soundFileName = "3_horse_tail.m4a",
                    playbackVisual = horseTailVisual,
                ),
                FairyTaleStoryLine(
                    text = "И верхом поеду в гости",
                    soundResourcePath = "files/horse_story/4_horse_ride.m4a",
                    soundFileName = "4_horse_ride.m4a",
